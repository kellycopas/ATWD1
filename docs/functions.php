...
//$writer->openURI($_SERVER['DOCUMENT_ROOT'] . '../data/currencies.xml');  //localhost path
$writer->openURI('/nas/students/k/kj2-copas/unix/public_html/atwd1/assignment/data/currencies.xml');
...
//$xml = simplexml_load_file($_SERVER['DOCUMENT_ROOT'] . '../data/currencies.xml') or die("Error: Cannot load currencies file");  //localhost path
$xml = simplexml_load_file('/nas/students/k/kj2-copas/unix/public_html/atwd1/assignment/data/currencies.xml') or die("Error: Cannot load currencies file");

// Start & initialise the writer
$writer = new XMLWriter();
//$writer -> openURI($_SERVER['DOCUMENT_ROOT'] . '../data/rates.xml');  //localhost path
$writer->openURI('/nas/students/k/kj2-copas/unix/public_html/atwd1/assignment/data/rates.xml');
$writer -> startDocument("1.0");
$writer -> startElement("currencies");
